...
| ------ | ---- | -------------------------------------------------- | ---- | ------ | ---- | ------------------------------- |
| 1      | 1    | Design review<br />project mgmt.<br />Git workflow |      | 4      | 7    | <mark>Aplha Presentation</mark> |
...
- Give a team presentation describing your [alpha release](https://classes.lanecc.edu/mod/url/view.php?id=4830746).
- Start sprint 4.
...
These are all due Sunday, April 26

- Individual Progress Report 4.

- Sprint 2 meeting report.
